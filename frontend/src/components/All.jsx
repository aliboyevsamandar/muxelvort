          ...
          {data.length > 0 ? (
            data.map((item) => (
              <div
                ...
                className="w-[270px] w-270px w-2xl-[270px] cursor-pointer max-w-sm bg-slate-900 rounded-xl hover:shadow-gray-500 hover:shadow-[0px_0px_13px_3px] duration-700 hover:scale-[1.02] h-[330px] flex flex-col"
              >
                <img
